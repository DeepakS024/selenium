...
namespace AgboolaBuyingTShirt.Test
{
    public class Agboola_Webdrive
    {
        ...
        public void WebdriveSaucedemo()
        {
            ...
            var lines = File.ReadAllLines(@"C:\Users\deepa\OneDrive\Desktop\selenium\tests\userdata.txt");
            ...
            var user=wait.Until(drv => drv.FindElement(By.Id("user-name")));
            user.SendKeys(lines[1]);
            var pwd=wait.Until(drv => drv.FindElement(By.Id("password")));
            pwd.SendKeys(lines[2]);
            Thread.Sleep(500);
            ...
            driver.FindElement(By.Id("first-name")).SendKeys(lines[3]);
            driver.FindElement(By.Id("last-name")).SendKeys(lines[4]);
            driver.FindElement(By.Id("postal-code")).SendKeys(lines[5]);
